...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center px-6 bg-light dark:bg-dark relative overflow-hidden"
    >
      {/* BG glow */}
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center z-10 pt-20">
        ...
        >
          ...
          >
            ...
            <span className="font-inter text-sm text-cyan">
              Available for work
            </span>
          </motion.div>
          ...
          >
            Passionate Full Stack Developer specializing in MERN Stack, Next.js,
            TypeScript, JavaScript, Python, and Flutter. Currently in final year
            at PUB, Bogura — working on thesis research targeting IEEE
            publication.
          </motion.p>
          ...
          >
            <a
              href="#projects"
              className="px-8 py-3 bg-cyan text-dark font-space font-semibold rounded-full hover:bg-cyan-light transition-all duration-300"
            >
              View Projects
            </a>
            <a
              href="/Tanzid_Mondol_Resume.pdf"
              download="Tanzid_Mondol_Resume.pdf"
              className="px-8 py-3 border border-gray-300 dark:border-dark-border text-dark dark:text-white font-space rounded-full hover:border-cyan hover:text-cyan transition-all duration-300"
            >
              Download CV
            </a>
          </motion.div>
        ...
        >
          <div className="relative">
            ...
            >
              <p className="font-inter text-xs text-gray-500 dark:text-white/40">
                Stack
              </p>
              <p className="font-space text-sm text-cyan font-bold">
                MERN + Next.js
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="font-space text-sm text-dark dark:text-white font-bold">
                PUB, Bogura
              </p>
            </motion.div>
          </div>
